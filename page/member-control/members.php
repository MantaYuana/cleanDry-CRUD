...
<section id="member" class="vh-100">
    <div class="container">
        <br>
        <div class="page-heading d-flex justify-content-between align-items-center">
            <div>
                <h6 class="mt-3">Admin <span class="fw-bolder text-decoration-underline">Menu</span></h6>
                <h2 class="fw-medium" style="color: var(--mc-green-dark);">Configure <span class="fw-bolder" style="color: var(--mc-green-dark-mono);">Members</span></h2>
            </div>
            <div>
                <button type="button" class="btn btn-primary p-2 ps-5 pe-5"><a class="link-underline link-light link-underline-opacity-0" href="../page/page.php?page=register-member">Add Member</a></button>
            </div>
        </div>
        <br>
        ...
        <div class="card shadow mb-4">
            <div class="card-header p-3">
                <h6 class="m-0 font-weight-bold">List of Members</h6>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-hover align-middle nowrap" id="dataTable">
                        ...
                        <td class='text-center'>
                            <a type='button' class='btn btn-warning me-3' href='../page/page.php?page=edit-member&idMember=$value[0]'>
                        ...
                        (SELECT id FROM transaksi WHERE id_member=$value[0])"));
                                if ($available[0] == 0) {
